...
// Check maintenance authentication
function checkMaintenanceAuth() {
    const token = getToken();
    const user = getCurrentUser();
    
    console.log('Checking maintenance auth...');
    ...
    showToast('Access denied. Maintenance only.', 'error');
    setTimeout(() => {
        window.location.href = '../../pages/Authentication/login.html';
    }, 2000);
    return false;
...
function showLoading(elementId) {
    ...
    if (element) {
        element.innerHTML = '<div class="text-center py-4"><i class="fa-solid fa-spinner fa-spin"></i> Loading...</div>';
    }
}

// Format currency without decimal .00
